...
const About: React.FC = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-6 py-24">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2 relative animate-slide-in-right">
            ...
            <div className="overflow-hidden rounded-lg shadow-2xl h-[500px] group">
                <OptimizedImage 
            ...
            <div className="relative max-w-4xl mx-auto">
                ...
                <div className="space-y-12">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between relative group">
                        <div className="md:w-5/12 bg-white p-6 rounded-2xl shadow-lg border border-slate-100 text-right relative hover:-translate-y-2 transition-transform duration-300">
                        ...
                        <div className="md:w-2/12 flex justify-center relative z-10 my-4 md:my-0">
                            <div className="w-12 h-12 bg-blue-900 text-white rounded-full flex items-center justify-center border-4 border-slate-50 font-bold shadow-lg z-10 relative">
                    ...
                    {/* Item 2 */}
                    <div className="flex flex-col md:flex-row-reverse items-center justify-between relative group">
                        <div className="md:w-5/12 bg-white p-6 rounded-2xl shadow-lg border border-slate-100 text-left relative hover:-translate-y-2 transition-transform duration-300">
                        ...
                        <div className="md:w-2/12 flex justify-center relative z-10 my-4 md:my-0">
                            <div className="w-12 h-12 bg-cyan-500 text-white rounded-full flex items-center justify-center border-4 border-slate-50 font-bold shadow-lg z-10 relative">
      ...
      <div className="relative py-32 bg-fixed bg-center bg-cover" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80')" }}>
        {/* Dark Overlay */}
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-center text-white">
            <div className="p-4 hover:scale-105 transition-transform duration-300 group">
              <span className="block text-5xl md:text-6xl font-bold text-cyan-400 mb-2 group-hover:text-white transition-colors">
                +<CountUp end={10} />
              </span>
              <span className="text-slate-300 text-xs font-bold uppercase tracking-widest">Años de Experiencia</span>
            </div>
            <div className="p-4 hover:scale-105 transition-transform duration-300 group">
              <span className="block text-5xl md:text-6xl font-bold text-cyan-400 mb-2 group-hover:text-white transition-colors">
                +<CountUp end={50} />
              </span>
              <span className="text-slate-300 text-xs font-bold uppercase tracking-widest">Países Cubiertos</span>
            </div>
            <div className="p-4 hover:scale-105 transition-transform duration-300 group">
              <span className="block text-5xl md:text-6xl font-bold text-cyan-400 mb-2 group-hover:text-white transition-colors">
                <CountUp end={5000} suffix="+" />
              </span>
              <span className="text-slate-300 text-xs font-bold uppercase tracking-widest">Envíos Exitosos</span>
            </div>
            <div className="p-4 hover:scale-105 transition-transform duration-300 group">
              <span className="block text-5xl md:text-6xl font-bold text-cyan-400 mb-2 group-hover:text-white transition-colors">24/7</span>
              <span className="text-slate-300 text-xs font-bold uppercase tracking-widest">Soporte Dedicado</span>
            </div>
          </div>
        </div>
      </div>
